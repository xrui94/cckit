...
// 矩阵运算
Mat4f transform = Mat4f::fromTranslation(Vec3f(1.0f, 2.0f, 3.0f));
Vec3f transformed = transform * Vec3f(0.0f, 0.0f, 0.0f);
...
```cmake
# 构建共享库
option(CCKIT_BUILD_SHARED "构建共享库" OFF)
